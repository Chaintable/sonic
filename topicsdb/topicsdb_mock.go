...
func (m *MockIndex) FindInBlocks(ctx context.Context, from, to idx.Block, pattern [][]common.Hash, limit uint) ([]*types.Log, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindInBlocks", ctx, from, to, pattern, limit)
...
func (mr *MockIndexMockRecorder) FindInBlocks(ctx, from, to, pattern, limit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindInBlocks", reflect.TypeOf((*MockIndex)(nil).FindInBlocks), ctx, from, to, pattern, limit)
}
