...
require (
	github.com/Chaintable/pipeline v0.0.45 // indirect
...
replace github.com/ethereum/go-ethereum => github.com/Chaintable/go-ethereum-sonic v0.0.0-20250418083651-eaac0395990a
