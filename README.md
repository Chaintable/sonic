...
> Fork of [0xsoniclabs/sonic](https://github.com/0xsoniclabs/sonic), with Chaintable pipeline patches.
...
Building Sonic requires both a Go (version 1.26 or later) and a C compiler. You can install
